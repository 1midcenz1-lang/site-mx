...
CLIENT_WAITING_REVIEW_TEXT = "درحال بررسی پرداختت هستیم."
CLIENT_APPROVED_TEXT = "خرید شما تایید شد."
...
def api_system_status():
    return jsonify({"ok": True, "site_update_mode": setting_bool("site_update_mode", False), "site_domain_move_mode": setting_bool("site_domain_move_mode", False), "site_domain_move_target": get_setting("site_domain_move_target", DEFAULT_SITE_DOMAIN_MOVE_TARGET)})
